...
{
  "query": "What is the difference between a web search API and a research agent?",
  "answer": "A web search API returns relevant documents for a query. A research agent typically uses search as one step in a larger, multi-step process that evaluates sources and synthesizes a response.",
  "sources": [
    {
      "title": "Example result title",
      "url": "https://example.com/search-vs-research",
