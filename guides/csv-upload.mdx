...
description: "Upload and enrich large CSV datasets through the Reprompt dashboard."
---

Upload a CSV of places and enrich them in bulk — no code required. Files must be under **200 MB** and include a header row.

Go to **[Datasets → Upload dataset](https://app.repromptai.com/place-enrichment/upload-csv)** to get started.
...
<Frame>
  <img src="/images/csv_upload/preview.png" alt="Preview showing records selected, ready to import as datasets" />
</Frame>

## Run Enrichment

Select datasets from the list, click **Enrich N datasets...**, choose **Enrich Place**, and start processing.

<Frame>
  <img src="/images/csv_upload/datasets-selected.png" alt="Datasets list with datasets selected showing Enrich button" />
</Frame>
...
- **Use descriptive dataset names** — name by geography, date, or purpose (e.g. "texas" or "Q1 2025 Store Locations").
