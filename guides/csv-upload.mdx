...
After importing, select **Enrich Place** to start enriching your datasets. This runs place enrichment across all imported batches.

<Frame>
  <img src="/images/csv_upload/enrich-place.png" alt="Select Enrich Place to start enrichment" />
</Frame>
