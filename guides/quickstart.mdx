...
<Note>
**Don't have place data yet?** You can generate your own collection of places using our [Find Places tool](/guides/finding-places) or experiment with csv data and custom AI attributes in our [Workbooks](https://app.repromptai.com/workbooks).
</Note>
