...
description: "How to diagnose and fix 401, 403, and 404 errors in your API requests"
---
...
<Steps>
  <Step title="Verify your organization slug matches your API key">
    ...
    1. Check that the `{org_slug}` in your URL matches your organization
    2. Confirm you're logged into the correct organization at [Dashboard](https://app.repromptai.com/organization)
    3. Make sure your API key belongs to the organization you're trying to access
  </Step>
</Steps>
